...
<div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; 商品管理 &gt; 编辑信息</div>
<div id="contentTab">
    <ul class="tab_nav">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>商品货号：</th>
                <td><asp:TextBox ID="txtGoodsNo" runat="server" CssClass="txtInput normal" maxlength="100" /></td>
            </tr>
            <tr>
                <th>库存数量：</th>
